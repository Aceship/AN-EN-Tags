...
let charaFileJP = JSON.parse(fs.readFileSync("../../ArknightsGameData_YoStar/ja_JP/gamedata/excel/character_table.json","utf8"))
let charaFileKR = JSON.parse(fs.readFileSync("../../ArknightsGameData_YoStar/ko_KR/gamedata/excel/character_table.json","utf8"))
