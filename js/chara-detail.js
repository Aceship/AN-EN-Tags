    ...
    function GetAudio (opdataFull,lang="en"){
        ...
        curraudiolist.forEach(element => {
            ...
            Object.keys(voiceDict.dict).forEach(dict => {
                ...
                <div style="display:inline-block">
                <audio preload="metadata" controls style="margin-top:10px"> <source src="${preDir}${foldername.toLowerCase()}/${wordKey}/${element.voiceId}.mp3" type="audio/mp3">Your browser does not support the audio tag.</audio> 
